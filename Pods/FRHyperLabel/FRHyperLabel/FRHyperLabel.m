...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:243/255.0 green:166/255.0 blue:131/255.0 alpha:1];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:200/255.0 green:103/255.0 blue:103/255.0 alpha:1];
	}
}
